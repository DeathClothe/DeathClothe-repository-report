...
| US-17 | Buscar prenda en favoritos| Como usuario quiero buscar por nombre dentro de mis prendas favoritas para encontrar fácilmente una prenda específica. |  | EP07 |
...
| US-26 | Cambiar idioma en app web | Como usuario quiero poder cambiar el idioma en toda la aplicación para usarla cómodamente en el idioma que prefiera. |  | EP07 |
