...
| US-14 | Visualizar detalles de prenda | Como usuario quiero poder ver la foto, el precio y la descripción de una prenda para decidir si me interesa comprarla y contactarme con el vendedor. |  | EP07 |
| US-15 | Conocer al vendedor | Como usuario quiero ver quién me está vendiendo la prenda (nombre e imagen del usuario) para tener más confianza y detalles adicionales. |  | EP07 |
| US-16 | Filtrar por tipo en el armario |Como usuario quiero poder filtrar mi armario virtual por tipo de ropa (polo, pantalón, vestido, etc.) para tener un mejor orden visual. | | EP07 |
