...
| Edad                                     | 27 años                                                                                                                         |                                                              | Distrito                                 | Lima - Surco                                                                                                                    |                                                              | Inicio de la entrevista                  | 00:00                                                                                                                           |
| Foto captura                             | <img src="./Report_Assets/AgustinValidation.png">                                                                               |                                                             | Diseño de presentación del producto      | El diseño le pareció claro, intuitivo y agradable, con una navegación fluida. Mencionó que no                                   |
|                                          | tuvo problemas para encontrar lo que buscaba.                                                                                   |
| Información de presentación del producto | Le quedo claro el mensaje que  es una plataforma para vender ropa. Los botones, instrucciones                                   |
|                                          | e imágenes comunican bien la propuesta de valor.                                                                                |
| Visualización de la pagina               | Menciono del buen rendimiento de la app y que todo se visualiza correctamente en general.                                       |                                                   
| Evaluación de funcionalidades clave      | Valoró mucho la funcionalidad de “favoritos” y sugirió agregar un historial de recientemente vistos. También propuso un sistema |                                                              |                                          |  de opiniones de otros compradores, lo que demuestra interés en características que ayuden a tomar mejores decisiones.          |

**Entrevista 2**
|         Dato                             |                                                                                                                                 |                                                               |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Entrevistado                             | Anyelo Bill Alejos Jesús                                                                                                        |                                                    
| Edad                                     | 20 años                                                                                                                         |                                                              | Distrito                                 | Lima - Comas                                                                                                                    |                                                              | Inicio de la entrevista                  |                                                                                                                                 |
| Foto captura                             | <img src="./Report_Assets/AnyeloValidation.png">                                                                                |                                                             | Diseño de presentación del producto      | El diseño fue percibido como atractivo y bien estructurado. Mencionó que la interfaz es clara y visualmente agradable,          |
|                                          | lo cual facilitó su comprensión inicial del propósito de la plataforma                                                          |
| Información de presentación del producto | El mensaje principal de la página quedó claro desde el primer vistazo: es una plataforma para vender ropa. Los botones,         |
|                                          | instrucciones e imágenes comunican bien la propuesta de valor.                                                                  |                                                              
| Visualización de la pagina               | Comento que la experiencia fue positiva y le daría una puntuación de 8/10. Destacó la estética agradable del diseño             |
|                                          | y la buena experiencia de uso, aunque hay pequeños detalles por pulir.                                                          |                                                   
| Evaluación de funcionalidades clave      | Propuso que cumple con las expectativas del usuario. Considera especialmente útil el sistema de filrtos por talla y estilo,     |   
|                                          | ya que agilizan su búsqueda de prendas.                                                                                         |    

**Entrevista 3**
|         Dato                             |                                                                                                                                 |                                                               |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Entrevistado                             | 	Daniela Alessandra Cigueñas Tarrillo                                                                                           |                                                    
| Edad                                     | 19 años                                                                                                                         |                                                              | Distrito                                 | Lima - Los Olivos                                                                                                               |                                                              | Inicio de la entrevista                  |                                                                                                                                 |
| Foto captura                             | <img src="./Report_Assets/DanielaValidation.png">                                                                               |                                                             | Diseño de presentación del producto      | La entrevistada  considera que el diseño es visualmente atractivo, con una estética amigable que facilita la navegación.        |
|                                          | Los colores como el rosado y blanco le resultaron agradables y llamaron su atención desde el primer vistazo.                    |                                                              
| Información de presentación del producto | Opina que la información está clara y cumple con lo que se espera de una aplicación de compra y venta de ropa usada.            |
|                                          | Desde la landing page se entiende el propósito de la plataforma y cómo usarla.                                                  |
| Visualización de la pagina               | Menciona que no experimentó errores de carga ni problemas visuales. Considera que la navegación es sencilla y que los           |
|                                          | elementos están bien distribuidos. Todo está visible y funcional, y no encontró formularios o pantallas fuera de lugar.         |                                                   
| Evaluación de funcionalidades clave      | Destaca lo fácil que fue navegar, modificar tallas, encontrar prendas como polos o vestidos, y utilizar filtros. Sugirió        |
|                                          | como mejora incluir conjuntos de prendas en lugar de solo unidades sueltas.                                                     |
...
| Edad                                     | 20 años                                                                                                                         |                                                              | Distrito                                 | Lima - Los Olivos                                                                                                               |                                                              | Inicio de la entrevista                  |                                                                                                                                 |
| Foto captura                             | <img src="./Report_Assets/DavidValidation.png">                                                                                 |                                                             | Diseño de presentación del producto      | El diseño fue descrito como ordenado, claro y bien jerarquizado. El entrevistado valoró que cada elemento estaba bien ubicado,  |
|                                          |lo cual facilitó la comprensión inmediata de la plataforma. Mencionó que el diseño resulta atractivo y amigable para el usuario. |
|                                          | Los colores como el rosado y blanco le resultaron agradables y llamaron su atención desde el primer vistazo.                    |                                                              
| Información de presentación del producto | El mensaje central de la plataforma fue comprendido sin dificultad. El entrevistado captó claramente que se trata de una        |
|                                          | aplicación para vender ropa, con un enfoque en la moda y la  visibilidad de los vendedores.                                     |
| Visualización de la pagina               | No se detectaron problemas visuales en la carga o disposición de las pantallas. La interfaz fue percibida como limpia y         |
|                                          | estructurada. Se destacó la rapidez con la que se muestran los elementos en pantalla y lo intuitivo del recorrido visual        |  
|                                          | tanto en la landing page como en la aplicación.                                                                                 |                                                   
| Evaluación de funcionalidades clave      | Las funcionalidades principales como publicar prendas, editar, eliminar, ver estadísticas y explorar productos fueron           |
|                                          | altamente valoradas. El entrevistado sugirió como mejora agregar trazabilidad más detallada.                                    |
**Entrevista 3**
