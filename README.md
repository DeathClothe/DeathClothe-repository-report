...
| 30    | TS-01         | Diseño y creación de base de datos relacional para DeathClothe    | Como desarrollador backend, necesito diseñar e implementar un esquema de base de datos MySQL que almacene usuarios, prendas, calificaciones y transacciones, para garantizar consistencia y escalabilidad del sistema. | 8           |
| 31   | TS-02         | Implementación de consultas optimizadas para filtros avanzados      | Como desarrollador, necesito implementar consultas SQL eficientes que permitan filtrar prendas por talla, color, estado y tipo, para mejorar la experiencia de búsqueda del usuario. | 8            |
| 32    | TS-03         | Relación entre prendas y armario virtual del usuario   | Como desarrollador, necesito establecer relaciones en MySQL entre las prendas compradas o favoritas y el armario virtual de cada usuario, para que puedan visualizar su estilo y recibir recomendaciones. | 8           |
| 33    | TS-04         | Visualización responsive del catálogo de ropa  | Como desarrollador frontend, necesito diseñar la interfaz del catálogo para que se adapte correctamente en dispositivos móviles y de escritorio, permitiendo un scroll fluido. | 8            |
| 34    | TS-05       | Editor de publicaciones con validación de campos   | Como desarrollador frontend, quiero que el formulario de subida de prendas valide en tiempo real los campos obligatorios (foto, precio, categoría), para evitar errores. | 8           |
| 35    | TS-06         | Componente frontend de "Tendencias"   | Como frontend developer, quiero crear un componente visual que muestre el contenido más reseñado y valorado de la semana, basado en datos reales. | 8           |
| 36    | TS-07         | Agregar índices en campos clave de MySQL   | Como desarrollador, quiero agregar índices en campos consultados frecuentemente como idContenido, idUsuario, genero y titulo, para mejorar el rendimiento. | 8           |
...
| **Inicio de la entrevista**               | 30:33                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Foto captura**                          | <img src="./Report_Assets/JhonValidation.png">                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Interacción con la plataforma**         | Mencionó que la plataforma le pareció bastante intuitiva desde el inicio. La navegación fue fluida, con una organización lógica de los menús y secciones. Resaltó la facilidad para encontrar productos y completar una compra sin complicaciones. Como sugerencia, propuso mejorar la búsqueda avanzada para filtrar por tallas, estilos o estados de las prendas (nueva, poco uso, vintage). También notó que algunos filtros no siempre respondían como se esperaba. |
| **Funcionalidades adicionales sugeridas** | Recomendó integrar botones para compartir productos directamente en redes sociales como Instagram o TikTok, con posibilidad de etiquetar al vendedor. También le gustaría recibir alertas personalizadas sobre rebajas en productos de su interés, recordatorios de wishlist, y la opción de seguir a vendedores frecuentes o favoritos.                                                                                                                                |
| **Accesibilidad y usabilidad**            | Afirmó que la app es accesible incluso para personas que no están muy familiarizadas con tecnología. Consideró que los íconos y botones eran reconocibles. Como punto de mejora, indicó que a veces las imágenes tardaban en cargar, especialmente en zonas con baja conexión, lo que afectaba la experiencia de navegación. Sugirió una versión "lite" o un mejor sistema de carga progresiva de contenido.                                                            |
| **Impacto visual y atractivo**            | El diseño visual fue uno de los aspectos más valorados. Lo describió como moderno, minimalista y con una buena elección de colores que evocan frescura y estilo. La tipografía le pareció clara y el uso de espacios en blanco facilitó la lectura. Mencionó que el diseño conecta con una audiencia joven interesada en moda urbana y sostenible.                                                                                                                      |
| **Comentarios finales**                   | En general, su experiencia fue muy positiva. Considera que la plataforma tiene un gran potencial si se pulen algunos detalles técnicos. Dijo que volvería a usarla y que la recomendaría, especialmente si se incluyen funciones más personalizadas. Valoró el enfoque en la moda circular y en apoyar a pequeños vendedores o emprendedores.                                                                                                                           |
