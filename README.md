...
| TF      | 11/07/2025 | - Bejarano Martínez, Álvaro Leandro<br>- Cabanillas Meza, José Mateo<br>- Luquillas Asto, Omar<br>- Santur Tello, Andrea Elizabeth<br>- Sarmiento Medina, Loreley | Se implementaron e integraron los servicios REST para el backend de DeathClothe, abarcando operaciones como autenticación de usuarios, manejo de perfiles, gestión de prendas y consulta de categorías. El equipo trabajó con enfoque modular y colaborativo, garantizando el funcionamiento y la interoperabilidad de los endpoints. Además, se incorporó el cambio de tema en la landing page, cerrando así el ciclo funcional completo del sistema. |
...
TF: En esta última etapa, el equipo consolidó el desarrollo del backend mediante la implementación completa de servicios REST, permitiendo la gestión integral de usuarios, autenticación, prendas y categorías. Se aseguraron la interoperabilidad y modularidad del sistema, trabajando en sincronización entre los integrantes. La colaboración fue constante a través de GitHub, donde se puede evidenciar la distribución de tareas mediante commits individuales, ramas asignadas por funcionalidad y validación cruzada de código. Además, se concluyó la documentación técnica del sistema y se integraron los últimos ajustes visuales en la interfaz, cerrando así el ciclo de desarrollo del proyecto DeathClothe.
...
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | **Bejarano Martínez, Alvaro Leandro**<br><br>**TB1**<br>Participó en presentaciones semanales y lideró la exposición sobre la arquitectura del sistema.<br><br>**TP1**<br>Desarrolló la Landing Page y funcionalidades clave del sistema.<br><br>**TB2**<br>Coordinó el desarrollo de la sección de recomendaciones y funcionalidades del módulo de favoritos.<br><br>**TF**<br>Desarrolló endpoints para obtener y actualizar el perfil de usuario, y para actualizar prendas de ropa, asegurando consistencia en el backend.<br><br>**Cabanillas Meza, José Mateo**<br><br>**TB1**<br>Expuso hallazgos de entrevistas con compradores y presentó mockups iniciales.<br><br>**TP1**<br>Diseñó e implementó funcionalidades visuales, incluyendo filtros.<br><br>**TB2**<br>Rediseñó las vistas de navegación y la sección “Explora”.<br><br>**TF**<br>Implementó endpoints para actualizar y eliminar prendas, demostrando dominio del flujo de datos entre capas.<br><br>**Luquillas Asto, Omar**<br><br>**TB1**<br>Apoyó en análisis de competencia y decisiones técnicas iniciales.<br><br>**TP1**<br>Codificó secciones como edición de prendas y validaciones de publicación.<br><br>**TB2**<br>Implementó autenticación del vendedor y funciones críticas de catálogo.<br><br>**TF**<br>Desarrolló las funciones de autenticación (login y registro), y personalización visual en landing.<br><br>**Santur Tello, Andrea Elizabeth**<br><br>**TB1**<br>Lideró diseño de wireframes y validación de requerimientos.<br><br>**TP1**<br>Programó vistas esenciales como favoritos y detalles de prenda.<br><br>**TB2**<br>Consolidó documentación y gestionó integración de módulos como el chat.<br><br>**TF**<br>Desarrolló endpoints de consulta para perfiles y categorías, mejorando la interacción con datos estructurados.<br><br>**Sarmiento Medina, Loreley**<br><br>**TB1**<br>Moderó sesiones y explicó el flujo de usuario en el sistema.<br><br>**TP1**<br>Desarrolló interfaz de usuario y organizó el backend a partir del diseño.<br><br>**TB2**<br>Implementó el armario virtual y la búsqueda dentro del sistema.<br><br>**TF**<br>Programó múltiples endpoints para acceder a ropa y categorías, asegurando cobertura de recursos del sistema.<br><br> | El equipo consolidó su liderazgo compartido al integrar desarrollo frontend, backend y documentación. Cada integrante asumió tareas técnicas clave, evidenciando un alto nivel de especialización y autonomía para cerrar el ciclo de desarrollo del producto. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | **Bejarano Martínez, Alvaro Leandro**<br><br>**TB1**<br>Contribuyó en la definición técnica del sistema y validación de arquitectura.<br><br>**TP1**<br>Participó en reuniones de planificación y programación de lógica funcional.<br><br>**TB2**<br>Revisó código en equipo y planificó pruebas técnicas.<br><br>**TF**<br>Desarrolló funcionalidades clave en endpoints REST bajo arquitectura modular.<br><br>**Cabanillas Meza, José Mateo**<br><br>**TB1**<br>Facilitó sesiones para entender necesidades de usuario.<br><br>**TP1**<br>Planificó tareas de frontend y prototipado.<br><br>**TB2**<br>Organizó flujos visuales del sistema y dirigió ajustes de experiencia.<br><br>**TF**<br>Implementó lógica de actualización y eliminación en el backend, mejorando eficiencia de gestión.<br><br>**Luquillas Asto, Omar**<br><br>**TB1**<br>Colaboró en discusión de soluciones técnicas.<br><br>**TP1**<br>Se encargó de la codificación gráfica tras el diseño inicial.<br><br>**TB2**<br>Documentó endpoints y contribuyó a integración visual.<br><br>**TF**<br>Desarrolló e integró la autenticación y la personalización temática, elevando la experiencia de usuario.<br><br>**Santur Tello, Andrea Elizabeth**<br><br>**TB1**<br>Guió sesiones de análisis y organizó el trabajo visual.<br><br>**TP1**<br>Coordinó tareas de codificación funcional y estructura de informe.<br><br>**TB2**<br>Validó funcionalidades con usuarios y optimizó diseño centrado en experiencia.<br><br>**TF**<br>Colaboró en la consulta de entidades, asegurando integridad de los datos disponibles.<br><br>**Sarmiento Medina, Loreley**<br><br>**TB1**<br>Estableció lineamientos visuales y arquitectónicos del proyecto.<br><br>**TP1**<br>Planificó la estructura inicial del frontend y backend.<br><br>**TB2**<br>Facilitó organización documental y coherencia visual del producto.<br><br>**TF**<br>Desarrolló endpoints para recursos visuales y funcionales como prendas y categorías.<br><br> | El equipo aplicó lo aprendido en los entregables anteriores para trabajar de forma sincronizada, cumpliendo los objetivos técnicos planteados. Se observó una planificación detallada, división eficiente de tareas y compromiso integral con el cierre del desarrollo. |
...
| **Authentication**| POST  | POST: `/api/v1/authentication/sign-in`<br>POST: `/api/v1/authentication/sign-up` |  `name`, `lastname`, `email`, `password`, `direction`, `type` |  POST `http://localhost:3000/api/v1/authentication/sign-in` |Autentica al usuario con las credenciales especificadas y devuelve un token JWT para autenticación.| 
